...
<li>Requirements</li>
<p>Install all the libraries mentioned in requirments.txt by running the following command after navigating to the folder where you have cloned the repo</br> pip install -r requirements.txt</br></p>
